		...
		<div class="bodytext_area box_inner">			
			...
			<p class="btn_line txt_right">
				<c:if test="${sessionScope.userId != null
					and sessionScope.userId == userDTO.id}">
					<a onclick="deletePost()" class="btn_bbs">삭제하기</a>
					<a href="/edit?num=${dto.num}&${pageRequestDTO.link}" class="btn_bbs">수정하기</a>
				</c:if>
				<a href="/list?num=${dto.num}&${pageRequestDTO.link}" class="btn_bbs">목록</a>
			</p>
