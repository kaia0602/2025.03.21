...
<div id="wrap">
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">	
			<form action="board_write_process.jsp" method="POST" onsubmit="return validateForm(this);">		
			...
			<p class="btn_line txt_right">
				<button type="submit" value="글쓰기" class="btn_srch">글쓰기</button>
				<button type="button" onclick="location.href='notice_list.jsp';" class="btn_bbs">목록</button>
			</p>
			</form>
