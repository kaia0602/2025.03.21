	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			...
			<% 
					...
					String uri = "/Tourist_mvc_model2/boardList.do";
					%>
				<a href="<%= uri%>?pageNum=1" class="firstpage  pbtn"><img src="img/btn_firstpage.png" alt="첫 페이지로 이동"></a>
				<a href="<%= uri%>?pageNum=<%=pageTemp-1 %>" class="prevpage  pbtn"><img src="img/btn_prevpage.png" alt="이전 페이지로 이동"></a>
				<% 
				while(blockCount <= blockPage && pageTemp <= totalPages) {
					if(pageTemp == pageNum) {
						out.print("<a href="+uri+"?pageNum="+pageTemp+"><span class='pagenum currentpage'>"+pageTemp+"</span></a>");
					}else {
						out.print("<a href="+uri+"?pageNum="+pageTemp+"><span class='pagenum'>"+pageTemp+"</span></a>");
					}
					pageTemp++;
					blockCount++;
				...
				%>
				<a href="<%= uri%>?pageNum=<%=pageTemp+1 %>"><img src="img/btn_nextpage.png" alt="다음 페이지로 이동"></a>
				<a href="<%= uri%>?pageNum=<%=totalPages %>" class="lastpage  pbtn"><img src="img/btn_lastpage.png" alt="마지막 페이지로 이동"></a>
			</div>
			<!-- //pagination -->
