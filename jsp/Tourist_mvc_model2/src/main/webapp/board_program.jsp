...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- bodytext_area -->
		<div class="bodytext_area place_area box_inner">				<ul class="program_list clear">
				<c:forEach var="dto" items="${programLists}" varStatus="loop">
					<li>
						<img class="img_place" src="img/${dto.img}"/>
						<h3>${dto.title}</h3>
						<p class="subttl">${dto.schedule}</p>
						<div class="program_content">
							<p>${dto.text}<span class="subtxt">${dto.subtext}</span></p>
						</div>
						<p class="btn_more"><a onclick="btn('${dto.title}')">더보기</a></p>
					</li>
				</c:forEach>
			</ul>
